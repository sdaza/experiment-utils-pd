...
# Backward-compatible re-exports (prefer experiment_utils.shrinkage or the
# package top-level). Kept so ``from experiment_utils.utils import ...`` still works.
from .shrinkage import (  # noqa: E402, F401
